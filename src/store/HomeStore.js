...
export default class HomeStore {
  ...
  // 1. 可以通过observable进行监听 2. 也可以通过extendObservable工具函数进行属性拷贝
  // @observable amount = 0;
  ...
  // @observable currentIndicator = null;

  // @observable currentRange = [moment().format('YYYY-HH-mm'), moment().format('YYYY-HH-mm')];
